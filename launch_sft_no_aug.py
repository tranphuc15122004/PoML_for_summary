...
def build_config(
    ...
    train_data: str = "data/sft_train_no_aug.jsonl",
    val_data: str = "data/sft_val_no_aug.jsonl",
) -> SFTConfig:
    gpu = detect_gpu_config()
    model_short = _model_short_name(model_path)
    if output_dir is None:
        output_dir = f"models/sft_no_aug_{model_short}"
    return SFTConfig(
        model=ModelConfig(
        ...
        run_name=f"sft_no_aug_{model_short}_{int(epochs)}ep",
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="SFT no-aug launcher")
    parser.add_argument("--model", type=str, default=DEFAULT_MODEL,
                        help=f"Model path (default: {DEFAULT_MODEL})")
    parser.add_argument("--train_data", type=str, default="data/sft_train_no_aug.jsonl",
                        help="Training data path")
    parser.add_argument("--val_data", type=str, default="data/sft_val_no_aug.jsonl",
    ...
    if args.output_dir is None:
        ...
        args.output_dir = f"models/sft_no_aug_{model_short}"
